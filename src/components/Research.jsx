  ...
  const publications = [
    {
      ...
      abstract: "Materials innovation remains constrained by fragmented data, weak experiment–computation coupling, and slow iteration cycles that often exceed a decade from concept to deployment. We introduce DataScribe, an AI-native, ontology-aligned web platform that unifies heterogeneous experimental and computational data into a machine-actionable knowledge graph and couples it with real-time multi-objective Bayesian optimization (MOBO) and active learning.",
      keywords: ["Materials informatics", "FAIR data", "Ontology", "Knowledge graph", "Active learning", "Multi-objective Bayesian optimization", "High-entropy alloys", "Energy materials", "Digital twins", "Uncertainty quantification", "Supply-chain resilience"],
      highlights: [
    ...
    },
    {
      ...
      abstract: "We present TRAM-MP, a feed-forward method for reconstructing global trajectories and body motions of multiple people from monocular videos with moving cameras. Building on TRAM's scene-centric philosophy, we extend it to multi-person scenarios through three key contributions.",
      keywords: ["Computer Vision", "3D Reconstruction", "Human Motion Capture", "Deep Learning", "Multi-Person Tracking", "SLAM"],
      highlights: [
      ...
      <div className="research-container">
        ...
        <div className="publications-section">
          ...
          <p className="publications-note">
            The following publications are currently in preparation and expected to be published in 2025.
          </p>
            ...
            <div key={index} className="publication">
              ...
              {pub.link && (
                <div className="publication-link-container">
                  ...
                  >
                    <span>{pub.link.includes('github') ? 'View Repository →' : 'View Platform →'}</span>
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="research-experience-note">
          ...
          <p className="research-note-text">
            As a Master's student in Computer Science at Texas A&M University, my research focuses on
            machine learning-powered computer vision for human modeling and 3D reconstruction in dynamic
            scenes with multiple bodies. I am also contributing to materials informatics research through
            my work on the DataScribe platform, bridging AI/ML techniques with materials science applications.
          </p>
        </div>
      </div>
    </section>
